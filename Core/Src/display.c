...
void display7SEG(int k)
{
  ...
  case 1:
    ...
    HAL_GPIO_WritePin(GPIOA, LED_A_Pin | LED_D_Pin | LED_E_Pin | LED_F_Pin | LED_G_Pin, GPIO_PIN_SET);
    break;
  case 2:
    HAL_GPIO_WritePin(GPIOA, LED_A_Pin | LED_B_Pin | LED_D_Pin | LED_E_Pin | LED_G_Pin, GPIO_PIN_RESET);
